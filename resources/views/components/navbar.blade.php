...
<nav class="relative px-4 py-4 flex justify-between items-center">
    ...
    <ul
        class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 md:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
        <li><a class="text-sm text-gray-400  hover:text-white" href={{ url('/') }}>Home</a></li>
        ...
        <li><a class="text-sm text-gray-400 hover:text-white" href="#">Projects</a></li>
        <li class="text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li><a class="text-sm text-gray-400 hover:text-white" href="{{ url('pricing') }}">Pricing</a></li>
        <li class="text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" class="w-4 h-4 current-fill"
                viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <li><a class="text-sm text-gray-400 hover:text-white" href={{ url('faq') }}>Faq</a></li>
    </ul>
