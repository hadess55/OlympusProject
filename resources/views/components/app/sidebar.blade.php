...
<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-900 dark:bg-gray-800">
        <a href="#" class="flex items-center my-5 ml-14">
            <img src="{{ asset('Images/logo2.png') }}" class="h-6 md:h-9" alt="Flowbite Logo" />
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ url('admin') }}"
                    ...
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-gray-900"
