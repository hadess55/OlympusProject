<x-layout>
    <section class="pt-10 lg:pt-[120px] pb-12 lg:pb-[90px]">
        <div class="container">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full px-2">
                    <div class="text-center mx-auto mb-12 lg:mb-20 max-w-[510px]">
                        <span class="text-white font-semibold text-lg mb-2 block">
                            Our Services
                        </span>
                        <h2 class=" text-white font-bold text-3xl sm:text-4xl md:text-[40px] mb-4">
                            What We Offer
                        </h2>
                        <p class="text-white ">
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4">
                    <div class="p-10 md:px-7 xl:px-10 rounded-[20px] bg-gray-800 shadow-md hover:shadow-lg mb-8 ">
                        <div
                            class="w-[70px] h-[70px] flex items-center justify-center bg-gray-900 rounded-2xl mb-8 hover:scale-125  hover:shadow-lg hover:shadow-purple-500/50 transition duration-300 ease-in-out">
                        ...
                        <h4 class="font-semibold text-xl text-white mb-3 hover:text-purple-500">
                            Refreshing Design
                        </h4>
                        <p class="text-white hover:text-pink-500">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4">
                    <div class="p-10 md:px-7 xl:px-10 rounded-[20px] bg-gray-800 shadow-md hover:shadow-lg mb-8 ">
                        <div
                            class="w-[70px] h-[70px] flex items-center justify-center bg-gray-900 rounded-2xl mb-8 hover:scale-125 transition duration-300 ease-in-out hover:shadow-lg hover:shadow-purple-500/50">
